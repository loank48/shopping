...
$ret = mysqli_query($con,"
    SELECT 
        ...
        s.subcategory as subcatname
    FROM 
        products p
    JOIN 
        category c ON c.id = p.category
    JOIN 
        subcategory s ON s.id = p.subCategory
    WHERE 
        p.category = (SELECT category FROM products WHERE id = '$pid')
        AND p.id != '$pid'
");
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									Vnd <?php echo htmlentities($rws['productPrice']);?>
								</span>
